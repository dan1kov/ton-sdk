  ...
  var qrcode2 = function() {
    ...
    function qrPolynomial(num, shift) {
      ...
      var _num = function() {
        ...
        var _num2 = new Array(num.length - offset2 + shift);
...
const ScrollContainer = (props) => {
  ...
  const offset2 = () => isMobile() ? 150 : 200;
  const maxHeight = () => props.maxHeight !== void 0 ? `${props.maxHeight}px` : `${windowHeight() - offset2()}px`;
...
const tonConnectUiVersion = "2.0.6";
class TonConnectUI {
  constructor(options) {
